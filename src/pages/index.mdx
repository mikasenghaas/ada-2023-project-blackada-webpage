...
import top_10_features from "../assets/images/top_k_features_overall.png"
import top_10_features_dark from "../assets/images/top_k_features_overall_dark.png"
import cluster_plot from "../assets/images/cluster_plot.png"
import cluster_plot_dark from "../assets/images/cluster_plot_dark.png"
import distribution_dark from "../assets/images/distribution_dark.png"
...
<ImageWithCaption
    id="top_10_features"
    srcLight={top_10_features}
    srcDark={top_10_features_dark}
    caption="Top 10 Features Overall"
    alt="top-10-features-overall"
/>
...
<ImageWithCaption
    id="cluster_plot"
    srcLight={cluster_plot}
    srcDark={cluster_plot_dark}
    caption=""
    alt="cluster-plot"
/>
...
<ImageWithCaption
    id="distribution"
    srcLight={distribution}
    srcDark={distribution_dark}
    caption=""
